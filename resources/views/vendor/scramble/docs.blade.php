...
">
@if(session('basic_auth_authenticated'))
    <span style="color: green; margin-right: 10px;">Authenticated as: {{ session('basic_auth_user', 'User') }}</span>
    <a href="{{ route('docs.logout') }}" style="color: var(--color-text-danger); text-decoration: none;">Logout</a>
@else
    <span style="color: orange;">Authentication Required</span>
@endif
</div>
